<?php
 	...
 	if(isset($_POST['save']))
 	{
 		...
 		$sql = mysql_query("SELECT * FROM tbl_registration WHERE username='$uname' AND 
 			password='$pass' AND log_type='$logtype'");
...
<html>
<head>
	<title>Login</title><link rel="icon" href="images/i/rc-logo.jpg">
</head>
